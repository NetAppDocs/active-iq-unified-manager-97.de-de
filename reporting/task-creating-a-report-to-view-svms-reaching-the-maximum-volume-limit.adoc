...
Auf der Grundlage der im Bericht gezeigten Ergebnisse sollten Sie möglicherweise die Volumes, die Storage VMs zugewiesen sind, ausgleichen oder, falls möglich, die maximal zulässigen Volumes mit ONTAP System Manager ändern.
